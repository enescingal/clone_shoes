...
import 'package:clone_shoes/pages/wishlist_page.dart';
import 'package:clone_shoes/theme/color.dart';
import 'package:clone_shoes/util/constant.dart';
import 'package:clone_shoes/util/drawer_json.dart';
                    ...
                    icon: selectedIndex == 1
                        ? ElasticIn(
                            child: SvgPicture.asset(
                                ...
                                height: 20))
                        : SvgPicture.asset("assets/images/cart_inactive.svg",
                            height: 20),
                  )
                ],
              ),
                    ...
                    icon: selectedIndex == 2
                        ? ElasticIn(
                            child: SvgPicture.asset(
                                ...
                                height: 20))
                        : SvgPicture.asset("assets/images/heart_inactive.svg",
                            height: 20),
                  ),
                  IconButton(
                    onPressed: () {
                    ...
                    icon: selectedIndex == 3
                        ? ElasticIn(
                            child: SvgPicture.asset(
                                ...
                                height: 20))
                        : SvgPicture.asset("assets/images/user_inactive.svg",
                            height: 20),
                  )
                ],
              ),
